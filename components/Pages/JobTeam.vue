<template>
  <admin-layout>
    ...
    <ui-grid ref="jobGrid" :component="this" :filter="true"  :columns="columns" :pager="true" :limiter="true" :search="true" resource_url="backend/job/index" :export="false" :limit_options="limitOpt" :defaultOrderDir="'desc'">
